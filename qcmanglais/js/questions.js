function questions(numero)
{
	...
	switch(numero)
	{
		...
		case 3:
		chaine="An ------- describes a person or a thing*noun*verb*adverb*adjective*4";		break;
		case 4:
		chaine="Can you ------ a photo of us.*take*make*have*do*1";		break;
		case 5:
		chaine="Where do you -------- ? I'm from Chile.*come to*come from*come back from*come to from*2";		break;
		case 6:
